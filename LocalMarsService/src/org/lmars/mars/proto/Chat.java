...
public final class Chat {
  ...
  public static final class SendMessageRequest extends
    ...
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
      ...
      return Chat.internal_static_com_tencent_mars_sample_chat_proto_SendMessageRequest_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Chat.SendMessageRequest.class, Chat.SendMessageRequest.Builder.class);
    }
    ...
    public static Chat.SendMessageRequest parseFrom(
    ...
    public static Chat.SendMessageRequest parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Chat.SendMessageRequest parseFrom(
    ...
    public static Chat.SendMessageRequest parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static Chat.SendMessageRequest parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static Chat.SendMessageRequest parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(Chat.SendMessageRequest prototype) {
    ...
    public static final class Builder extends
        ...
        Chat.SendMessageRequestOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Chat.internal_static_com_tencent_mars_sample_chat_proto_SendMessageRequest_descriptor;
      }
      ...
      public Chat.SendMessageRequest getDefaultInstanceForType() {
        return Chat.SendMessageRequest.getDefaultInstance();
      }

      public Chat.SendMessageRequest build() {
        Chat.SendMessageRequest result = buildPartial();
      ...
      public Chat.SendMessageRequest buildPartial() {
        Chat.SendMessageRequest result = new Chat.SendMessageRequest(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Chat.SendMessageRequest) {
          return mergeFrom((Chat.SendMessageRequest)other);
        } else {
      ...
      public Builder mergeFrom(Chat.SendMessageRequest other) {
        if (other == Chat.SendMessageRequest.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Chat.SendMessageRequest parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Chat.SendMessageRequest) e.getUnfinishedMessage();
          throw e;
        } finally {
  ...
  public static final class SendMessageResponse extends
    ...
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
      ...
      return Chat.internal_static_com_tencent_mars_sample_chat_proto_SendMessageResponse_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Chat.SendMessageResponse.class, Chat.SendMessageResponse.Builder.class);
    }
    ...
    /**
     * Protobuf enum {@code SendMessageResponse.Error}
     */
    public enum Error
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return Chat.SendMessageResponse.getDescriptor().getEnumTypes().get(0);
      }
      ...
      // @@protoc_insertion_point(enum_scope:SendMessageResponse.Error)
    }
    ...
    public static Chat.SendMessageResponse parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static Chat.SendMessageResponse parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Chat.SendMessageResponse parseFrom(
    ...
    public static Chat.SendMessageResponse parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static Chat.SendMessageResponse parseFrom(
    ...
    public static Chat.SendMessageResponse parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static Chat.SendMessageResponse parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(Chat.SendMessageResponse prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        ...
        Chat.SendMessageResponseOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Chat.internal_static_com_tencent_mars_sample_chat_proto_SendMessageResponse_descriptor;
      }
      ...
      public Chat.SendMessageResponse getDefaultInstanceForType() {
        return Chat.SendMessageResponse.getDefaultInstance();
      }

      public Chat.SendMessageResponse build() {
        Chat.SendMessageResponse result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public Chat.SendMessageResponse buildPartial() {
        Chat.SendMessageResponse result = new Chat.SendMessageResponse(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Chat.SendMessageResponse) {
          return mergeFrom((Chat.SendMessageResponse)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(Chat.SendMessageResponse other) {
        if (other == Chat.SendMessageResponse.getDefaultInstance()) return this;
        if (other.hasErrCode()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Chat.SendMessageResponse parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Chat.SendMessageResponse) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
