...
public class GetConversationListCgi {
    ...
    private static String[][] conDetails = new String[][]{
    ...
    public static Main.ConversationListResponse getconvlist(InputStream is) {
        try {
            final Main.ConversationListRequest request = Main.ConversationListRequest.parseFrom(is);

            System.out.println("request from access_token="+request.getAccessToken()+" type="+request.getType());
            ...
            System.out.println("request invalid "+e);
        }
        return null;
    }
}